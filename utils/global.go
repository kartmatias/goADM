...
func init() {
	...
	fileLogs.SetLogger(logs.AdapterMultiFile, `{"filename":"logs/goADM.log","separate":["emergency", "alert", "critical", "error", "warning", "notice", "info", "debug"],"level":7,"daily":true,"maxdays":10}`)
